            ...
            <div className="bg-white relative dark:bg-gray-800 rounded-lg shadow-xl p-6 max-w-4xl w-full max-h-[90vh] overflow-y-auto">
                ...
                <div className="flex items-center justify-between mb-6 border-b pb-4">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <button className="btn btn-primary px-4 py-2 rounded-md disabled:opacity-50" onClick={saveStatus} disabled={saving || loading}>
                            {saving ? 'Saving...' : 'Save'}
                        </button>
                        <button
                                ...
                                {lead?.serviceType === 'visa' && (
                                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                                        ...
                                        <div className="space-y-1">
                                            ...
                                            <p className="text-gray-800 dark:text-gray-200">{lead?.validity ? `${lead.validity} Days` : 'N/A'}</p>
                                        </div>
                                        <div className="space-y-1">
                                ...
                                {lead?.serviceType === 'tour' && (
                                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                                        <div className="space-y-1">
                                            ...
                                            <p className="text-gray-800 dark:text-gray-200">{lead?.destination || 'N/A'}</p>
                                        </div>
                                        <div className="space-y-1">
                                ...
                                {lead?.serviceType === 'travelInsurance' && (
                                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                                        ...
                                        <div className="space-y-1">
                                            ...
                                            <p className="text-gray-800 dark:text-gray-200">{lead?.price || 'N/A'}</p>
                                        </div>
                                    </div>
                                )}
                        ...
                        <div className="bg-gray-50 dark:bg-gray-900/50 rounded-lg p-4">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                                ...
                                <div className="space-y-1">
                                    ...
                                    <p className="text-gray-800 dark:text-gray-200">{lead?.createdAt ? formatDate(lead.createdAt) : 'N/A'}</p>
                                </div>
                            </div>
