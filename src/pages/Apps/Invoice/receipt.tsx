...
const formatCurrency = (amount: number, currency: string) => {
  ...
  useEffect(() => {
    const fetchInvoice = async () => {
      try {
        setLoading(true)
        const response = await axios.get(`${import.meta.env.VITE_BASE_URL}api/getAllReceipts/${companyId}/${"sales"}`)
  ...
  {viewInvoiceData && (
    ...
    >
      ...
      <div className="flex justify-between items-start mb-6">
        <div>
          <div className="w-32 h-36  bg-blue-600 rounded flex items-center justify-center ">
      ...
      <div className="grid grid-cols-1 gap-6 mb-6">
        ...
        <div>
          <h3 className="font-semibold text-gray-800 mb-1">Received From:</h3>
